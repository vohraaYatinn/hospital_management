							...
							<div className="rounded shadow overflow-hidden sticky-bar">
								...
								<div className="text-center avatar-profile margin-nagative mt-n5 position-relative pb-4 border-bottom">
									...
									<p className="text-muted mb-0">
										{calculateAge(patientsData?.date_of_birth)} Years old
									</p>
								</div>
											...
											{activeSubIndex === 1 && (
												<div
													...
													<p className="text-muted mt-4 mb-0">
														{
															patientsData?.appointments?.find(
																(appointments) => appointments.id == appointment
															)?.patients_query
														}
													</p>
												...
												<div className={`tab-pane fade show active`}>
													<div className="row">
														...
														<Modal
															...
															<Modal.Body>
																<Prescription
																	patient={patientsData?.full_name}
																	medication={medication}
																	prescription={prescription}
																/>
															</Modal.Body>
			...
			<Drawer
				...
				{Object.keys(prescription.examination).length > 0 && (
					<div className="col-md-12 mt-4 row">
						...
						<div className="col-md-8 row">
							{Object.keys(prescription.examination).map(
								(med, index) =>
				...
				{Object.keys(prescription.systemic).length > 0 && (
					<div className="col-md-12 mt-4 row">
						...
						<div className="col-md-8 row">
							{Object.keys(prescription.systemic).map(
								(med, index) =>
						...
						<div className="col-md-8 row">
							<>
								<div className="col-md-10">
									{prescription.provisionalDiagnosis != "" && (
										<p>{prescription.provisionalDiagnosis}</p>
									)}
								</div>
								...
								<>
									<div className="col-md-10 mt-2">
										<li key={index}>
											...
											{med.medicineConsume} <br /> Dosage: {med.dosage} Per{" "}
				...
				{prescription.labReports.length > 0 ? (
					<div className="col-md-12 mt-4 row">
						...
						<div className="col-md-8 row">
							{prescription.labReports.map(
								(med, index) =>
									med != "" && (
										<>
											<div className="col-md-10 mt-2 text-capitalize">
												<li key={index}>
													{med}
													<br />
												</li>
