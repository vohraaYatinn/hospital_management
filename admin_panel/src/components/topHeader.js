                ...
                <li className="list-inline-item mb-0 ms-1">
                    <div className="dropdown dropdown-primary">
                        ...
                        <div className={`${userModal ? 'show' : ''} dropdown-menu dd-menu dropdown-menu-end shadow border-0 mt-3 py-3`} style={{minWidth:'200px',position:'absolute', right:'0'}}>
                            ...
                            <Link className="dropdown-item text-dark d-flex align-items-center" to="/admins"><span className="mb-0 d-inline-block me-1"><FiSettings className="align-middle h6 mb-0"/></span> Admins Settings</Link>
