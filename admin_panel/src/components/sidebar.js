				...
				<ul className="sidebar-menu">
					...
					<li
						...
						<Link
							to="#"
							onClick={(e) => {
								setSubManu(subManu === "layouts-item" ? "" : "layouts-item");
							}}>
							<PiBrowsers className="me-2 d-inline-block mb-0 icon" />
							Layouts
						</Link>
						<div
							...
							<ul>
								...
								<li
									className={`${
										manu === "index-sidebar-dark" ? "active" : ""
									} ms-0`}>
									<Link to="/index-sidebar-dark">Dark Sidebar</Link>
								</li>
								<li
									className={`${
										manu === "index-sidebar-colored" ? "active" : ""
									} ms-0`}>
					...
					<li
						className={`sidebar-dropdown ms-0 ${
							["chat", "email", "calendar", "app-item"].includes(manu)
								? "active"
								: ""
						}`}>
						<Link
							...
							<AiOutlineAppstore className="me-2 d-inline-block mb-0 icon" />
							Apps
						</Link>
						<div
							className={`sidebar-submenu ${
							...
							<ul>
								...
								<li className={`${manu === "email" ? "active" : ""} ms-0`}>
									<Link to="/email">Email</Link>
								</li>
								<li className={`${manu === "calendar" ? "active" : ""} ms-0`}>
					...
					<li
						...
						<Link
							to="#"
							onClick={(e) => {
								setSubManu(subManu === "pharmacy-item" ? "" : "pharmacy-item");
							}}>
							<PiShoppingCart className="me-2 d-inline-block mb-0 icon" />
							Pharmacy
						</Link>
						<div
							className={`sidebar-submenu ${
							...
							<ul>
								<li className={`${manu === "shop" ? "active" : ""} ms-0`}>
									<Link to="/shop">Shop</Link>
								</li>
								<li
									className={`${
										manu === "product-detail" ? "active" : ""
									} ms-0`}>
									<Link to="/product-detail">Shop Detail</Link>
								</li>
								<li className={`${manu === "shopcart" ? "active" : ""} ms-0`}>
									<Link to="/shopcart">Shopcart</Link>
								</li>
								<li className={`${manu === "checkout" ? "active" : ""} ms-0`}>
					...
					<li
						className={`sidebar-dropdown ms-0 ${
							["blog-detail", "blogs", "blog-item"].includes(manu)
								? "active"
								: ""
						}`}>
						<Link
							...
							<MdFlip className="me-2 d-inline-block mb-0 icon" />
							Blogs
						</Link>
						<div
							className={`sidebar-submenu ${
								["blog-detail", "blogs", "blog-item"].includes(subManu)
									? "d-block"
									: ""
							}`}>
							<ul>
								<li className={`${manu === "blogs" ? "active" : ""} ms-0`}>
									<Link to="/blogs">Blogs</Link>
								</li>
								<li
									className={`${manu === "blog-detail" ? "active" : ""} ms-0`}>
					...
					<li
						...
						<Link
							...
							<FaRegFile className="me-2 d-inline-block mb-0 icon" />
							Pages
						</Link>
						<div
							className={`sidebar-submenu ${
							...
							<ul>
								...
								<li
									className={`${manu === "invoice-list" ? "active" : ""} ms-0`}>
									<Link to="/invoice-list">Invoice List</Link>
								</li>
								<li className={`${manu === "invoice" ? "active" : ""} ms-0`}>
									<Link to="/invoice">Invoice</Link>
								</li>
								<li className={`${manu === "terms" ? "active" : ""} ms-0`}>
									<Link to="/terms">Terms & Policy</Link>
								</li>
								<li className={`${manu === "privacy" ? "active" : ""} ms-0`}>
									<Link to="/privacy">Privacy Policy</Link>
								</li>
								<li className={`${manu === "blank-page" ? "active" : ""} ms-0`}>
					...
					<li
						...
						<Link
							...
							<BsEnvelopeOpen className="me-2 d-inline-block mb-0 icon" />
							Email Template{" "}
						</Link>
						<div
							className={`sidebar-submenu ${
							...
							<ul>
								...
								<li
									className={`${manu === "email-alert" ? "active" : ""} ms-0`}>
									<Link to="/email-alert">Alert</Link>
								</li>
								<li
									className={`${
										manu === "email-invoice" ? "active" : ""
									} ms-0`}>
									<Link to="/email-invoice">Invoice</Link>
								</li>
							</ul>
						</div>
					</li>
					...
					<li
						...
						<Link
							...
							<BiLogOutCircle className="me-2 d-inline-block mb-0 icon" />
							Authentication
						</Link>
						<div
							className={`sidebar-submenu ${
							...
							<ul>
								<li className={`${manu === "login" ? "active" : ""} ms-0`}>
									<Link to="/login">Login</Link>
								</li>
								<li className={`${manu === "signup" ? "active" : ""} ms-0`}>
									<Link to="/signup">Signup</Link>
								</li>
								<li
									className={`${
										manu === "forgot-password" ? "active" : ""
									} ms-0`}>
									<Link to="/forgot-password">Forgot Password</Link>
								</li>
								<li
									className={`${manu === "lock-screen" ? "active" : ""} ms-0`}>
					...
					<li
						...
						<Link
							to="#"
							onClick={(e) => {
								setSubManu(subManu === "ui-item" ? "" : "ui-item");
							}}>
							<TbFileInfo className="me-2 d-inline-block mb-0 icon" />
							UI Components{" "}
						</Link>
						<div
							className={`sidebar-submenu ${
							...
							<ul>
								<li className={`${manu === "ui-button" ? "active" : ""} ms-0`}>
									<Link to="/ui-button">Buttons</Link>
								</li>
								<li className={`${manu === "ui-badges" ? "active" : ""} ms-0`}>
									<Link to="/ui-badges">Badges</Link>
								</li>
								<li className={`${manu === "ui-alert" ? "active" : ""} ms-0`}>
									<Link to="/ui-alert">Alert</Link>
								</li>
								<li
									className={`${manu === "ui-dropdown" ? "active" : ""} ms-0`}>
									<Link to="/ui-dropdown">Dropdowns</Link>
								</li>
								<li
									className={`${
										manu === "ui-typography" ? "active" : ""
									} ms-0`}>
									<Link to="/ui-typography">Typography</Link>
								</li>
								<li
									className={`${
										manu === "ui-background" ? "active" : ""
									} ms-0`}>
									<Link to="/ui-background">Background</Link>
								</li>
								<li className={`${manu === "ui-text" ? "active" : ""} ms-0`}>
									<Link to="/ui-text">Text Color</Link>
								</li>
								<li
									className={`${
										manu === "ui-tooltip-popover" ? "active" : ""
									} ms-0`}>
									<Link to="/ui-tooltip-popover">Tooltips & Popovers</Link>
								</li>
								<li className={`${manu === "ui-shadow" ? "active" : ""} ms-0`}>
									<Link to="/ui-shadow">Shadows</Link>
								</li>
								<li className={`${manu === "ui-border" ? "active" : ""} ms-0`}>
									<Link to="/ui-border">Border</Link>
								</li>
								<li className={`${manu === "ui-form" ? "active" : ""} ms-0`}>
									<Link to="/ui-form">Form Elements</Link>
								</li>
								<li
									className={`${
										manu === "ui-pagination" ? "active" : ""
									} ms-0`}>
									<Link to="/ui-pagination">Pagination</Link>
								</li>
								<li className={`${manu === "ui-avatar" ? "active" : ""} ms-0`}>
									<Link to="/ui-avatar">Avatars</Link>
								</li>
								<li className={`${manu === "ui-modals" ? "active" : ""} ms-0`}>
									<Link to="/ui-modals">Modals</Link>
								</li>
								<li className={`${manu === "ui-icons" ? "active" : ""} ms-0`}>
					...
					<li
						...
						<Link
							...
							onClick={(e) => {
								setSubManu(
									subManu === "miscellaneous-item" ? "" : "miscellaneous-item"
								);
							}}>
							<BsPostcard className="me-2 d-inline-block mb-0 icon" />
							Miscellaneous{" "}
						</Link>
						<div
							className={`sidebar-submenu ${
...
>>>>>>> 0a980a3c8c4104fdf81b517414825ce7e8438e82
